...
import { GenericBgServiceService } from 'app/modules/net-banking/new-reusable-components/generic-bg-component/generic-bg-service.service';
...
@Component({
  selector: 'app-add-export-sw-bill',
  templateUrl: './add-export-sw-bill.component.html',
  styleUrls: ['./add-export-sw-bill.component.scss']
})
export class AddExportSwBillComponent implements OnInit {
