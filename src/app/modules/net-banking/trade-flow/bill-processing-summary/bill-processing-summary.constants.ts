export class billProcessingConstants {
  static readonly BILL_SUMMARY = [
    {
      columnDef: "Name",
      header: "Name",
    ...
    {
      columnDef: "Invoice No",
      header: "Invoice No",
      cell: (element: any) => element.invoiceNo,
    },
    {
      columnDef: "Bill Category",
      header: "billCatagory",
      cell: (element: any) => element.billCatagory,
    },
    {
      columnDef: "Bill Id",
      header: "Bill Id",
    ...
    {
      columnDef: "Submitted on",
      header: "Assigned to",
      cell: (element: any) => element.requestAssignedTo,
    },
    {
      columnDef: "Bill Amount",
      header: "Audit Status",
      cell: (element: any) => {},
    },
    {
    ...
    {
      columnDef: "ransaction Status",
      header: "Assigned to",
      cell: (element: any) => element.requestAssignedTo,
    },
    {
      columnDef: "Assigned To",
      header: "Assigned to",
      cell: (element: any) => element.requestAssignedTo,
    },
    {
      columnDef: "Audit Status",
      header: "Assigned to",
      cell: (element: any) => element.requestAssignedTo,
    },
  ];

  static readonly BILLTEMPLATE_SUMMARY = [
    {
      columnDef: "name",
      header: "Applicant",
      cell: (element: any) => element.name,
  ...
  static readonly billStaticData = [
    {
      name: 1,
      invoiceNo: 8765,
      submitted: "manisha",
  ...
  static readonly LC_SUMMARY = [
    {
      columnDef: "lcMasterId",
      header: "LC Number",
      cell: (element: any) => element.lcMasterId,
    },
    {
      columnDef: "invoiceNo",
      header: "Invoice No",
