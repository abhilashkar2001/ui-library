import { Component, EventEmitter, Input, OnInit, Output, SimpleChanges, ViewChild, OnChanges, AfterViewInit } from '@angular/core';
...
export class CardStepperComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (this.optionalSteps && this.optionalSteps.steps.length && this.optionalSteps.isDifferentMobile) {
      this.loanstepper && this.loanstepper.splice(2, 0, ...this.optionalSteps.steps)
    }
  }
